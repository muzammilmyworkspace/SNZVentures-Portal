...
const EDUCATION_ITEM: IntakeField[] = [
  ...
  { key: "eduStart", label: "Start of studies", type: "date", required: true },
  {
    key: "eduEnd",
...
const WORK_ITEM: IntakeField[] = [
  ...
  { key: "wkFrom", label: "From", type: "date" },
  { key: "wkTo", label: "To", type: "date", hint: "Leave blank if you still work there." },
  {
    key: "wkDuties",
  ...
  steps: [
    ...
    /* ═══════════════════════════════════════════════════ 02 ═══ */
    {
      ...
      fields: [
        ...
        { key: "passportIssue", label: "Issue date", type: "date", required: true },
        {
          key: "passportExpiry",
          label: "Expiry date",
          type: "date",
        ...
        { key: "trpExpiry", label: "Permit valid until", type: "date", showWhen: { key: "trp", equals: "Yes" } },
        {
          key: "refusal",
